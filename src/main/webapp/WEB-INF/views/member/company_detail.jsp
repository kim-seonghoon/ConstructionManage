...
<form name="formmCp" id="formmCp" method="POST">
	<div>
		...
		<tr>
			<th>공사 업체명*</th>
			<td><input type="text" name="" id="cp_name"></td>
			<th>사업자 번호*</th>
			<td><input type="text" name="cp_num1"> - <input type="text" name="cp_num2"> </td>	<!-- 사업자번호 id, name 확인 -->
		</tr>
		
		<tr>
			<th>담당자*</th>
			<td><input type="text" name="admin_name" id="name">   </td>
			<th>담당자 연락처*</th>
			<td><input type="text" name="admin_p1"> - <input type="text" name="admin_p2"> - <input type="text" name="admin_p3"></td>
		</tr>
		
		
		<tr>
			<th>이메일</th>
			<td colspan="3"><input type="text" name="cp_email" id="email"></td>
		</tr>
		
		
		<tr>
			<th>연락처*</th>
			<td><input type="text" name="cp_p1"> - <input type="text" name="cp_p2"> - <input type="text" name="cp_p3"></td>
			<th>팩스번호</th>
