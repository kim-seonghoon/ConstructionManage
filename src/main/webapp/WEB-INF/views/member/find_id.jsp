<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="container bbs_main" style="padding-top: 20px; padding-bottom: 10px">
		<h3 style="margin-left: 170px; margin-top: 0">| 아이디 찾기</h3>
		<div class="login_box" style="padding-top: 40px">
	    <form method="post" action="find_id" id="member">
	        <fieldset>
	        ...
	        <div id="buttons">
	            <input type="submit" class="btn-black-lg" value="아이디 찾기">&nbsp;
