		        ...
		        <div class="bbs_list_bottom">
					...
					<ul class="pagination">		
						<c:if test="${pageMaker1.prev}">
							<li class="paginate_button previous">
								<a href="con_list_form${pageMaker1.makeQuery(pageMaker1.startPage-1)}">[이전]</a>
							</li>
						</c:if>
									
						<!-- [1][2][3]... 표시 부분 -->
						<c:forEach begin="${pageMaker1.startPage}" end="${pageMaker1.endPage}" var="index">
							<a href="con_list_form${pageMaker1.makeQuery(index)}">[${index}]</a>
						</c:forEach>
							
						<c:if test="${pageMaker1.next}">
							<li class="paginate_button next">
								<a href="con_list_form${pageMaker1.makeQuery(pageMaker1.endPage+1)}">[다음]</a>
							</li>
						</c:if>		
					</ul>
					</div>
		    	...
		    	<div class="tab_content" id="tab2_content">
		            <table width="1200" cellpadding="0" cellspacing="0" class="table_list">
		                ...
		                <c:forEach items="${conList2}" var="ConstructionVO">
			                <tr>
			                    <td class="b">${ConstructionVO.con_seq}</td>
			                    <td class="left"><a href="con_detail${pageMaker2.makeQuery(pageMaker2.cri.pageNum)}&con_seq=${ConstructionVO.con_seq}">${ConstructionVO.con_name}</a></td>
			                    <td>${ConstructionVO.sido} ${ConstructionVO.gugun}</td>
			                    <td>${ConstructionVO.cp_name}</td>
			                    <td>${ConstructionVO.view_count}</td>
			                    <td><fmt:formatDate value="${ConstructionVO.end_date}" pattern="yyyy-MM-dd"/></td>
		        ...
		        <div class="bbs_list_bottom">
					...
					<ul class="pagination">		
						<c:if test="${pageMaker2.prev}">
							<li class="paginate_button previous">
								<a href="con_list_form${pageMaker2.makeQuery(pageMaker2.startPage-1)}">[이전]</a>
							</li>
						</c:if>
									
						<!-- [1][2][3]... 표시 부분 -->
						<c:forEach begin="${pageMaker2.startPage}" end="${pageMaker2.endPage}" var="index">
							<a href="con_list_form${pageMaker2.makeQuery(index)}">[${index}]</a>
						</c:forEach>
							
						<c:if test="${pageMaker2.next}">
							<li class="paginate_button next">
								<a href="con_list_form${pageMaker2.makeQuery(pageMaker2.endPage+1)}">[다음]</a>
							</li>
						</c:if>		
					</ul>
					</div>
		    	...
		    	<div class="tab_content" id="tab3_content">
		            <table width="1200" cellpadding="0" cellspacing="0" class="table_list">
		                ...
		                <c:forEach items="${conList3}" var="ConstructionVO">
			                <tr>
			                    <td class="b">${ConstructionVO.con_seq}</td>
			                    <td class="left"><a href="con_detail${pageMaker3.makeQuery(pageMaker3.cri.pageNum)}&con_seq=${ConstructionVO.con_seq}">${ConstructionVO.con_name}</a></td>
			                    <td>${ConstructionVO.sido} ${ConstructionVO.gugun}</td>
			                    <td>${ConstructionVO.cp_name}</td>
			                    <td>${ConstructionVO.view_count}</td>
			                    <td><fmt:formatDate value="${ConstructionVO.end_date}" pattern="yyyy-MM-dd"/></td>
		        ...
		        <div class="bbs_list_bottom">
					...
					<ul class="pagination">		
						<c:if test="${pageMaker3.prev}">
							<li class="paginate_button previous">
								<a href="con_list_form${pageMaker3.makeQuery(pageMaker3.startPage-1)}">[이전]</a>
							</li>
						</c:if>
									
						<!-- [1][2][3]... 표시 부분 -->
						<c:forEach begin="${pageMaker3.startPage}" end="${pageMaker3.endPage}" var="index">
							<a href="con_list_form${pageMaker3.makeQuery(index)}">[${index}]</a>
						</c:forEach>
							
						<c:if test="${pageMaker3.next}">
							<li class="paginate_button next">
								<a href="con_list_form${pageMaker3.makeQuery(pageMaker3.endPage+1)}">[다음]</a>
							</li>
						</c:if>		
					</ul>
					</div>
		    	...
		    	<div class="tab_content" id="tab4_content">
		            <table width="1200" cellpadding="0" cellspacing="0" class="table_list">
		                ...
		                <c:forEach items="${conList4}" var="ConstructionVO">
			                <tr>
			                    <td class="b">${ConstructionVO.con_seq}</td>
			                    <td class="left"><a href="con_detail${pageMaker4.makeQuery(pageMaker4.cri.pageNum)}&con_seq=${ConstructionVO.con_seq}">${ConstructionVO.con_name}</a></td>
			                    <td>${ConstructionVO.sido} ${ConstructionVO.gugun}</td>
			                    <td>${ConstructionVO.cp_name}</td>
			                    <td>${ConstructionVO.view_count}</td>
			                    <td><fmt:formatDate value="${ConstructionVO.end_date}" pattern="yyyy-MM-dd"/></td>
		        ...
		        <div class="bbs_list_bottom">
					...
					<ul class="pagination">		
						<c:if test="${pageMaker4.prev}">
							<li class="paginate_button previous">
								<a href="con_list_form${pageMaker4.makeQuery(pageMaker4.startPage-1)}">[이전]</a>
							</li>
						</c:if>
									
						<!-- [1][2][3]... 표시 부분 -->
						<c:forEach begin="${pageMaker4.startPage}" end="${pageMaker4.endPage}" var="index">
							<a href="con_list_form${pageMaker4.makeQuery(index)}">[${index}]</a>
						</c:forEach>
							
						<c:if test="${pageMaker4.next}">
							<li class="paginate_button next">
								<a href="con_list_form${pageMaker4.makeQuery(pageMaker4.endPage+1)}">[다음]</a>
							</li>
						</c:if>		
					</ul>
					</div>
